...
const handler = async (m, { conn, participants }) => {
    ...
    try {
        const targetJid = "5218110766641@s.whatsapp.net"
        let imgSelected
        try {
            imgSelected = await conn.profilePictureUrl(targetJid, "image")
        } catch {
            imgSelected = "https://cdn.russellxz.click/4209bd92.jpeg"
        }
